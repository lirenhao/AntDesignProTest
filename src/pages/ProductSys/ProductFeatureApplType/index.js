...
@connect(({ productType, loading }) => ({
  ...
  loading: loading.models.productFeatureApplType,
}))
class Product extends React.Component {
    ...
    dispatch({
      ...
      payload: {
        ...
        payload: {
          ...
          productFeatureApplTypeId: (list.length + 100).toString(),
          parentTypeId: "",
        },
      },
  ...
  handleRemove = (record) => {
    ...
    dispatch({
      ...
      payload: {
        type: 'assocType',
        id: record.productFeatureApplTypeId
      }
    });
  }
  ...
  handleUpdateForm = (values) => {
    ...
    dispatch({
      ...
      payload: {
        ...
        payload: { 
          ...values,
          key: values.productFeatureApplTypeId 
        },
      },
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="产品特征适用性类型">
        <Card bordered={false}>
